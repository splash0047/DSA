# 016. Two Sum II - Input Array Is Sorted

- **Platform**: LeetCode
- **Problem Number**: #167
- **Difficulty**: Medium
- **URL**: [LeetCode #167 - Two Sum II - Input Array Is Sorted](https://leetcode.com/problems/two-sum-ii-input-array-is-sorted/)
...
Your solution must use only constant $\mathcal{O}(1)$ extra space.
